...
func (m *MockStorageManager) Get(ctx context.Context, cfg *config.Config) (*types.Registry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageManager) Store(ctx context.Context, cfg *config.Config, reg *types.Registry) error {
	m.ctrl.T.Helper()
