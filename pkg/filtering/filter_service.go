...
type FilterService interface {
	...
	ApplyFilters(ctx context.Context, reg *regtypes.Registry, filter *config.FilterConfig) (*regtypes.Registry, error)
}
...
func (s *DefaultFilterService) ApplyFilters(
	...
	filter *config.FilterConfig) (*regtypes.Registry, error) {
